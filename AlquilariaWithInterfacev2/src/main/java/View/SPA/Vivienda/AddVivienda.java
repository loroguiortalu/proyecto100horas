...
public class AddVivienda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelChooseLanguage1, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButtonActionPerformed
        ...
        try {
            if (adressField.getText().isEmpty() || rentField.getText().isEmpty() || m2Field.getText().isEmpty() || descriptionField.getText().isEmpty() || codeField.getText().isEmpty() || idField.getText().isEmpty()) {
                ...
                int housetyp = 1;
                String h = SelectorHouse.getSelectedItem().toString();
                if(h.contains("Casa")){
